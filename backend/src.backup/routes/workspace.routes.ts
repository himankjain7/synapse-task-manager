...
// Scoped Workspace Projects
router.get('/:workspaceId/projects', ProjectController.getAll);
router.post('/:workspaceId/projects', validateRequest(createProjectSchema), ProjectController.create);
