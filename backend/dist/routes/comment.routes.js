 ...
 */
router.get('/', validation_middleware_1.validatePagination, comment_controller_1.CommentController.listComments);
/**
 ...
 */
router.get('/:id', (0, validation_middleware_1.validateUUID)('id'), comment_controller_1.CommentController.getComment);
/**
 ...
 */
router.patch('/:id', (0, validation_middleware_1.validateUUID)('id'), validation_middleware_1.validateBody, (0, validation_middleware_1.validateRequired)(['content']), (0, validation_middleware_1.sanitizeFields)(['content']), comment_controller_1.CommentController.updateComment);
/**
 ...
 */
router.delete('/:id', (0, validation_middleware_1.validateUUID)('id'), comment_controller_1.CommentController.deleteComment);
/**
 ...
 * }
 */
router.get('/count', comment_controller_1.CommentController.getCommentCount);
/**
 * GET /comments/my
 ...
 */
router.get('/activity', comment_controller_1.CommentController.getActivityFeed);
